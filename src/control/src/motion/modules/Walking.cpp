...
Walking::Walking()
{
	...
	m_Joint.SetAngle(JointData::ID_R_SHOULDER_PITCH, 20.00); //-10
	m_Joint.SetAngle(JointData::ID_L_SHOULDER_PITCH, -20.00);  //10
	m_Joint.SetAngle(JointData::ID_R_SHOULDER_ROLL, 15.10);  //-15
    m_Joint.SetAngle(JointData::ID_L_SHOULDER_ROLL, -15.10);    //15
	m_Joint.SetAngle(JointData::ID_R_ELBOW, -125); // negativo frente
	m_Joint.SetAngle(JointData::ID_L_ELBOW,  125); // positivo frente
