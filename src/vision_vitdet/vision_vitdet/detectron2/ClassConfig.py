...
class classConfig():
	...
	def CheckConfig(self):
		...
		#while True:
		if self.Config.read('src/vision_vitdet/vision_vitdet/detectron2/config.ini') != []:
			...
			self.Config = ConfigParser()
			self.Config.write('vision_vitdet/vision_vitdet/detectron2/config.ini')
			...
			with open('src/vision_vitdet/vision_vitdet/detectron2/config.ini', 'wb') as configfile:
