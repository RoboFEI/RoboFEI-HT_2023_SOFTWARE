...
config_file = "/home/robo/detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_100ep.py"
...
def main(args):
    ...
    register_coco_instances("ball_train", {},"/home/robo/detectron2/train/_annotations.coco.json", "/home/robo/detectron2/train")
    register_coco_instances("ball_test", {}, "/home/robo/detectron2/test/_annotations.coco.json", "/home/robo/detectron2/test")

    cfg.dataloader.train.dataset.names = "ball_train"
    # my_dataset_train_metadata = MetadataCatalog.get("ball_train")
